...
--             vo.valorcond*vo.uxb cantminima,
                     ...
                     ( select distinct LISTAGG(vps.skuid, ', ') WITHIN GROUP (ORDER BY vps.skuid)
                        ...
                        case
                          when (INSTR(vp.dsleyendacorta,'BULTOS')<>0 and INSTR(vp.dsleyendacorta,'cada')<> 0) then
                              'cada '||DECODE(VP.UXB,0,vp.valorcond,vp.valorcond*vp.uxb)||'  UNIDADES'
  ...
  * %v 22/07/2021 - ChM -agrego valdiacinoo para no recibir v_clientsid_vtex = 1
  ************************************************************************************************/
  ...
  * %v 22/07/2021 - ChM -agrego valdiacion para no recibir v_clientsid_vtex = 1
  ************************************************************************************************/
