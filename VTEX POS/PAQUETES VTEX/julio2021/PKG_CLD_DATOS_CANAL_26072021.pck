           ...
           insert into VTEXCOLLECTIONSKU
                      ...
                      select distinct
                       ...
                       where pre.refid = vsk.refid
                         ...
                         and case
                             when colle.cdsucursal='9999    ' AND RevisaOfertaPromo(pre.refid,pre.id_canal,P_FECHA,'OF') = 1 then 1
                      ...
                      select distinct
                       ...
                       where vp.id_promo_pos = vps.id_promo_pos
                         ...
                         and vp.icprocesado = 1
                          --todas las sucursales si es para la 9999
                         and case
                             when colle.cdsucursal='9999    ' AND RevisaOfertaPromo(vps.refid,vp.id_canal,P_FECHA,'PR') = 1 then 1
