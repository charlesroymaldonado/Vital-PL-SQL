      ...
      select p.cdarticulo,
       ...
       where p.cdarticulo = vs.refid
         ...
         and p.id_canal in (select distinct vs.id_canal
          ...
          --excluye los articulos de VTEXpricespecial para no asignarles precio PL,PA o OF si estan aun vigentes 
          and p.cdarticulo not in (select e.refid 
                                     from vtexpricespecial e
                                    where e.cdsucursal=p.cdsucursal
                                      and e.id_canal=p.id_canal
                                      and pc_fecha between e.dtfromof and e.dttoof)                             
