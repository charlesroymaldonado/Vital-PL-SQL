  ...
  Begin
    ...
    if v_cantactivas = 0 then
      ...
      set tc.icactivo = 0,
          ...
          tc.icprocesado = 0
      where tc.idcuenta = r.idcuenta
        and trim(tc.icactivo) <> trim(r.icactivo) or trim(tc.iccomi) <> trim(r.iccomi);;
  ...
  PROCEDURE RefrescarPreciosVTEX (p_Fecha IN tblprecio.dtvigenciadesde%type) IS
      ...
      select p.cdarticulo,
       ...
       where p.cdarticulo = vs.refid
        ...
        --solo para prueba
       -- and p.cdarticulo in ('0133318 ','0177456 ','0177882 ')
        ...
        select A.amprecio
          ...
          from (select pre.amprecio,
                 ...
                 where pre.cdsucursal = p.cdsucursal
                   ...
                   and p_fecha between pre.dtvigenciadesde and pre.dtvigenciahasta
                   --solo para prueba
                -- and pre.cdarticulo in ('0133318 ','0177456 ','0177882 ')
              order by pre.dtmodificacion desc
                ) A
           ...
           insert into VTEXCOLLECTIONSKU
                      ...
                      select distinct
                        ...
                        from vtexpromotion vp,
                             ...
                             vtexsku          vs
                       where vp.id_promo_pos = vps.id_promo_pos
                         and vs.refid=vps.refid
                         and vs.skuid=vps.skuid
...
BEGIN
     ...
     END LOOP;
       --funcion para dsactivar promocioens que salen de POS
