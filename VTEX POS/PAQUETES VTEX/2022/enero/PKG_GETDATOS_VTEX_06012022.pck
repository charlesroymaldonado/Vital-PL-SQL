...
--             vo.valorcond*vo.uxb cantminima,
  ...
  BEGIN
    ...
    OPEN cur_out FOR
       ...
       where vc.cdsucursal = vs.cdsucursal
         ...
         and decode(vc.id_canal_alta,null,vs.id_canal,vc.id_canal_alta) = p_id_canal
         ;
  EXCEPTION
    WHEN OTHERS THEN
      n_pkg_vitalpos_log_general.write(1,
  ...
  * %V 06/01/2021 - ChM - Agrego id_canal_alta para mmejora de bajas son agente asignado
  ************************************************************************************************/
