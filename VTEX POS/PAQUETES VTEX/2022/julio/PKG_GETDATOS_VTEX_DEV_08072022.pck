  ...
  BEGIN
    ...
    OPEN cur_out FOR
        select t.id_cliente_dir,
               ...
               null Tiempo_serv,
               case 
                 when t.icactive=0 then 'Baja'
                 when t.icactive=1 and (t.latitud=0 or t.longitud=0) then 'Geolocalizar'
                 when t.icactive=1 then 'Cliente' 
               end tipo,
               t.legajo_vendedor||pe.dsnombre||pe.dsapellido legajo_vendedor,
