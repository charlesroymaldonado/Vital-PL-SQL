...
CREATE OR REPLACE PACKAGE BODY PKG_HABILITACION_APP_CENTRAL is
  ...
  * %v 22/07/2021 - ChM
  * %v 10/03/2022 - ChM agrego icactivo TLK
  *****************************************************************************************/
  ...
  Procedure GetAgente(p_identidad   IN entidades.identidad%TYPE,
    ...
    v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetAgente';
  ...
  *****************************************************************************************/
  ...
  Procedure GetHabilitaciones(p_identidad   IN entidades.identidad%TYPE,
    ...
    v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetHabilitaciones';
  Begin
  ...
  *****************************************************************************************/
  ...
  Procedure GetDireccionMail(p_identidad IN entidades.identidad%TYPE,
    ...
    v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetDireccionMail';
  ...
  * %v 8/3/2022   - ChM - mejora para no cambiar mail si es inactivación 
  *****************************************************************************************/
Procedure HabilitacionUsuario(p_identidadaplicacion IN tblentidadaplicacion.identidadaplicacion%TYPE,
                              p_identidad           IN entidades.identidad%type,
                              p_cdsucursal          IN tblcuenta.cdsucursal%type,
  ...
  v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.HabilitacionUsuario';
  -- vcont                 integer;
...
Begin
  ...
  --valido no recibir sucursal y id_cuenta en null
  if p_cdsucursal is null or p_idcuenta is null then
     p_error := 'No es Posible procesar cuenta de cliente o sucursal en null';
        return;
    end if;
  ...
  begin
    ...
    exception
     when no_data_found then
         null;
      when others then
         p_error := 'Por favor comuniquese con sistemas';
         return; 
    end;     
    ...
    --mejora para no cambiar mail si es inactivación ChM 8/3/2022
    if p_icactivo = 0 then 
...
End HabilitacionUsuario;
  ...
  *****************************************************************************************/
  ...
  Procedure GetAplicacionesPermisos(p_vlaplicacion IN TBLENTIDADAPLICACION.VLAPLICACION%type,
    ...
    v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetAplicacionesPermisos';
...
Procedure GetIdentidadAplicacion(p_Identidad           IN ENTIDADES.identidad%TYPE,
  ...
  v_Modulo VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetIdentidadAplicacion';
...
Procedure GetTieneTarjetaFidelizado(p_identidad  IN entidades.identidad%type,
  ...
  v_Modulo       VARCHAR2(100) := 'PKG_HABILITACION_APP_CENTRAL.GetTieneTarjetaFidelizado';
