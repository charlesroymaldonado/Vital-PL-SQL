...
CREATE OR REPLACE PACKAGE BODY PKG_PEDIDO_CENTRAL IS
  ...
  * %v 20/05/2021 ChM  agrego filtro ID_canal en la TBLGRUPOMATERIALESCONTROL  
  ************************************************************************************************************/
  FUNCTION  AjusteMaxBTO  (p_cdcuit          entidades.cdcuit%TYPE,
      ...
      Begin
        Select gm.cdgrupo,
         ...
         Where dgm.cdarticulo = PED.CDARTICULO
           --agrego filtro ID_canal
           And gm.id_canal = PED.ID_CANAL
           And gm.id_canal = dgm.id_canal
  ...
  ************************************************************************************************************/
  ...
  BEGIN
    ...
    FOR v_RegPed IN c_RegPed LOOP
      ...
      if trim(v_RegPed.Identidad) = 'IdCfReparto' and  nvl(trim(v_RegPed.Dsreferencia),'x') not like '%{%' then
           pkg_control.GrabarMensaje(sys_guid(),
                                    null,
                                    sysdate,
