...
BEGIN
  ...
  /*o	Texto del 1 + 40  el idCuenta  (cliente)
    ...
    o	Texto del 82 + 30 ammonto pedido
    
    o	Texto del 112 + 100  observaciones del pedido
  */
    begin
  ...
  --divido por 100 por que vtex envia los dos decimales en los ultimos 2 digitos
   v_ammonto:= to_number(trim(substr(p_cabecera,82,30)))/100;      
   begin
    ...
    v_observacion:= trim(substr(p_cabecera,112,100));
