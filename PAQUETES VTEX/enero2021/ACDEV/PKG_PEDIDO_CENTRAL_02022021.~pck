             ...
             AND pe.idpedido in
                 (select p.idpedido
                   ...
                   where p.idpedido = tx.idpedido
                     ...
                     and tx.cdcuit = p_cdcuit))
    LOOP
      --OOOJOOO ESTA VALIDACION NO SIRVE PARA PEDIDOS CON NONFOOD O PROMOCIONES GRANDES PORQUE EL PKG DIVIDIR NO SEPARA LAS PROMOS AÚN SI SUPERAN EL MONTO MINIMO PARA CF
  ...
  BEGIN
    ...
    FOR v_RegPed IN (SELECT pe.identidad,
     ...
     -- 28/07/16 RLC, Busca ID de Suc y Suc<>Armado
      ...
      --PARA LOS PEDIDOS DE TELEMARKETING SE ASIGNAN DNI CF DE ACUMDNI DE AC ""NO SE TOMARÁ EN CUENTA EL MANEJO PROPIO DEL PROVEEDOR DE TELE""
