...
* %v 24/06/2022 - ChM
--ojo validar estos casos para marcarlos
select t.razonsocial,t.cdtipodireccion,t.sqdireccion, count(*) from PERSATCLIENTES t
group by t.razonsocial,t.cdtipodireccion,t.sqdireccion
having count(*)>1;
***************************************************************************************************/
