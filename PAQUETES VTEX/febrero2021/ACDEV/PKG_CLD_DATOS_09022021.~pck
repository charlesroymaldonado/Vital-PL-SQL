...
BEGIN
     ...
     --falta construir la información de clientes que no tienen dirección para agregarle la dirección comercial única
  ...
  /*select cu.idcuenta,
   ...
   where de.identidad = cu.identidad
     ...
     and de.cdtipodireccion = 2     
     and de.icactiva = 1
     and cu.idcuenta = &v_id_cuenta
    ;
  --listo los clientes sin direccion 
  select vc.id_cuenta,
         vc.clientsid_vtex 
    from vtexclients vc 
