  ...
  *****************************************************************************************************/
  ...
  BEGIN
   ...
   END IF;
    ...
    (idconsolidadom,qtconsolidado,idpersona,cdestado,dtinsert,dtupdate,QTBTOCONSOLIDAR)
    VALUES
      (seq_consolidadom.nextval, 0, p_IdPersona, 1, SYSDATE, NULL,v_QtBtoConsolidar);
