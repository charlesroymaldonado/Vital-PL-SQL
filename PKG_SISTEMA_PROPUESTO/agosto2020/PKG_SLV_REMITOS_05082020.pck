CREATE OR REPLACE PACKAGE PKG_SLV_REMITOS is
  ...
  **********************************************************************************************************/
  ...
  PROCEDURE GetRemitoUbicacion(p_idRemito      IN  tblslvremito.idremito%type,
                           	   p_CursorInicial OUT CURSOR_TYPE,
                               p_Cursor        OUT CURSOR_TYPE);
...
--c_qtDecimales                                  CONSTANT number := 2; -- cantidad de decimales para redondeo
  ...
  * %v 05/08/2020 - ChM  devuelve dos cursores:
  *                      el primero null o la ubicación sugerida si existe
  *                      el segundo cursor el listado de todas las ubicaciones disponibles
  *****************************************************************************************************/
  PROCEDURE GetRemitoUbicacion(p_idRemito      IN  tblslvremito.idremito%type,
                           	   p_CursorInicial OUT CURSOR_TYPE,
                               p_Cursor        OUT CURSOR_TYPE)  IS 
   BEGIN
    --lista la ubicación sugerida
    OPEN p_CursorInicial FOR
