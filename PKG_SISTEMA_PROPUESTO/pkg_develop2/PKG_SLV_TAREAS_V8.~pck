...
--    GetTareasByUserId(v_cur_tarea,p_idpersona);  -- OJOO utilizar para validar el permiso del usuario autentificado
  ...
  BEGIN
    ...
    loop
     begin
       ...
       ||tarea.idconsolidadopedido||tarea.idconsolidadocomi||'Creado: '||to_char(tarea.dtinsert,'dd/mm/yyyy');
     ...
     open p_cursor for 
           select dta.cdarticulo Cdarticulo,
                  ...
                  PKG_SLV_Articulos.SetFormatoArticulos(dta.cdarticulo,
 ...
 /****************************************************************************************************
  * %v 28/02/2020 - ChM  Versión inicial borrar tareas por prueba
