...
/**************************************************************************************************
  ...
  ***************************************************************************************************/
   ...
   FUNCTION TieneTransIDHijos(p_idconsolidado tblslvconsolidadocomi.idconsolidadocomi%type)
    ...
    /**************************************************************************************************
  * %v 22/07/2020 - ChM  Procedimiento para verificar si un pedido de reparto tiene faltantes sin distribuir
                         devuelve 1 si tiene faltantes sin distribuir
  ...
  *    OOOOJJOOO pendiente la replica con AC para reportes BW                          
  ***************************************************************************************************/    
...
BEGIN
 ...
 -- Inserto en tabla de relación de pedidos con pedidos faltantes
    ...
    FOR r_pGF in c_pedidosAGenerarXFaltante LOOP
     ...
     -- Inserto la cabecera del pedido OJO AGREGAR REPLICA AC
