  ...
  *****************************************************************************************************/
   ...
   open p_Cursor for 
           select cod.cdarticulo,
                  ...
                  --codigo de barras
                  decode(cod.qtpiezaspicking,0,
                  PKG_SLV_ARTICULO.GetCodigoDeBarra(cod.qtunidadmedidabasepicking,'UN'),
                  PKG_SLV_ARTICULO.GetCodigoDeBarra(cod.qtpiezaspicking,'KG')) barras
