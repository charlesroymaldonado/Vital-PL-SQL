  ...
  BEGIN
   ...
   -- valida si son ambos null devuelve sector null        
    if v_idconsolidadopedido is null and v_idconsolidadocomi is null then
      ...
      --obtengo el modo de ingreso de la tarea consolidadoM para el articulo p_articulo
       begin
        select 
