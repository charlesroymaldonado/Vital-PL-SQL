  ...
  for promo in(
          ...
          loop
            ...
            if v_artant is not null and promo.cdarticulo <> v_artant then               
               --verifica si no distribuye todo la promo error
                v_error:= 'Error en distribución de promociones: '||
                          'ConsoPedido N°'||promo.idconsolidado||'Pedido N°'||promo.idpedido||
               ...
               --variables a NULL para buscar la cantidad a distribuir del proximo    
               v_artant:=null; 
 ...
 *****************************************************************************************************/
 ...
 for conformado in(
     ...
     loop
       ...
       v_qtunidadpedido:= PKG_SLV_ARTICULOS.CONVERTIRUNIDADES(conformado.cdarticulo,conformado.qtbase,'UN',v_cdunidadmedida, 0);       
       insert into tblslvpedidoconformado
                   (idpedido,
                    cdarticulo,
                    sqdetallepedido,
