...
****************************************************************************************************/
         ...
         select A.fechapedido,
           ...
           from (select cp.dtinsert fechapedido,
                  ...
                  where cp.identidad = e.identidad
                    ...
                    and (p_IdPedido = 0 or cp.idconsolidadopedido = p_idpedido)
              ...
              union all
                 select cc.dtinsert fechapedido,
                  ...
                  where cc.idcomisionista = e.identidad              
                    and (p_IdComi = 0 or cc.idconsolidadocomi = p_idComi)
  ...
  * %v 14/07/2020 - ChM  Obtener el estado por pedido
  *****************************************************************************************************/
...
/****************************************************************************************************
  ...
  *****************************************************************************************************/
  ...
  /****************************************************************************************************
  * %v 14/07/2020 - ChM  Versión inicial GetArticulosControl
  * %v 14/07/2020 - ChM  Obtener los articulos que componen un control de remito
  ****************************************************************************************************/
  ...
  BEGIN
    ...
    if  p_idcomi  <> 0 then
      --cabezera del reporte
       ...
       OPEN p_Cursor FOR
          select crd.cdarticulo||' - '||des.vldescripcion Articulo,
                         PKG_SLV_Articulo.SetFormatoArticuloscod(crd.cdarticulo,
                          --valida pesables
                          decode(nvl(crd.qtdiferenciapiezas,0),0,
                          (nvl(crd.qtdiferenciaunidadmbase,0)),
                          nvl(crd.qtdiferenciapiezas,0))) Cantidad, 
                         r.idremito,                                               
                         upper(pe.dsnombre) || ' ' || upper(pe.dsapellido) Armador,
