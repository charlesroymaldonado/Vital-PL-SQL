     ...
     OPEN p_Cursor FOR
             select re.idremito,
              ...
              where re.idtarea = ta.idtarea
                ...
                --valido el tipo de tarea para remito de faltante 40 y remitos de faltantes de faltante 44
  ...
  *****************************************************************************************************/
  ...
  BEGIN
    ...
    if p_TipoTarea in (c_TareaConsolidaPedidoFaltante ,c_TareaFaltanteConsolFaltante)then  
       GetRemitoF(p_idRemito,p_TipoTarea,p_Cursor);    
    end if;      
    ...
    if p_TipoTarea in (c_TareaConsolidadoComi,c_TareaConsolidadoComiFaltante) then   
      GetRemitoC(p_idRemito,p_TipoTarea,p_Cursor);    
    end if;   
   EXCEPTION
    WHEN OTHERS THEN
      n_pkg_vitalpos_log_general.write(2,
  ...
  BEGIN
    ...
    OPEN p_Cursor FOR
             ...
             select re.dtremito,
                    ...
                    nvl2(e.dsrazonsocial, e.dsnombrefantasia,'-') cliente,                           
                    '-' comisionista,
                    pers.dsnombre||' '||pers.dsapellido Armador,
                    es.dsestado,
                    re.idremito,
             ...
             select re.dtremito,
                    ...
                    0 IdcosolidadoFaltante,
                    '-' cliente,                           
                    NVL2 (e.dsrazonsocial, e.dsnombrefantasia,'-') comisionista,
                    pers.dsnombre||' '||pers.dsapellido Armador,
                    es.dsestado,
                    re.idremito,
                    re.nrocarreta,
