...
SELECT d.iddoctrx iddoctrx,
          ...
          TO_CHAR (d.dtdocumento, 'yyyymmdd') AS FECHADOCUMENTO,
          TO_CHAR (d.dtdocumento, 'HH24:MI:SS') AS HORADOCUMENTO,
          d.dtdocumento,
          TO_CHAR ( p.dtentrega, 'yyyymmdd') AS FECHAENTREGA,
          TO_CHAR ( p.dtentrega, 'HH24:MI:SS') AS HORAENTREGA,
          p.dtentrega,
          TO_CHAR ( p.dtaplicacion, 'yyyymmdd') AS FECHAPEDIDOPOS,
          TO_CHAR ( p.dtaplicacion, 'HH24:MI:SS') AS HORAPEDIDOPOS,
          p.dtaplicacion,
