CREATE OR REPLACE VIEW DW_PEDI_FALTANTES_COMI
(sucursal, idcomisionista, fecha_consolidado, articulo, precio_promedio_unidad, stock, unidades_pedidas, unidades_pickeadas, unidades_faltantes, canal)
AS
with conforma as  ( select A.idpedido,
        ...
        select pe.cdsucursal sucursal,
               ...
               /*(SELECT sum(t.stock)
                ...
                WHERE t.cdarticulo = pe.cdarticulo) stock,*/
               null stock,
