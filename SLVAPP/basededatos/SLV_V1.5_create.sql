...
-- Last modification date: 2020-01-28 18:32:44.964
...
CREATE TABLE tblslvTarea (
    ...
    idPersona char(40)  NOT NULL,
    idPersonaAsignacion char(40)  NOT NULL,
...
CREATE TABLE tbltmpslvConsolidadoM (
    ...
    idPersona char(40)  NOT NULL,
    idComisionista char(40)  NOT NULL,
...
-- Reference: FK_ConsolidadoComi_Remito (table: tblslvRemito)
ALTER TABLE tblslvRemito ADD CONSTRAINT FK_ConsolidadoComi_Remito
    FOREIGN KEY (idConsolidadoComi)
    REFERENCES tblslvConsolidadoComi (idConsolidadoComi);
...
-- Reference: FK_ConsolidadoPedido_Remito (table: tblslvRemito)
ALTER TABLE tblslvRemito ADD CONSTRAINT FK_ConsolidadoPedido_Remito
    FOREIGN KEY (idConsolidadoPedido)
    REFERENCES tblslvConsolidadoPedido (idConsolidadoPedido);
...
-- Reference: FK_PedFaltanteRel_Remito (table: tblslvRemito)
ALTER TABLE tblslvRemito ADD CONSTRAINT FK_PedFaltanteRel_Remito
    FOREIGN KEY (idPedFaltanteRel)
    REFERENCES tblslvPedFaltanteRel (idPedFaltanteRel);
...
-- Reference: FK_Remito_TareaDet (table: tblslvTareaDet)
ALTER TABLE tblslvTareaDet ADD CONSTRAINT FK_Remito_TareaDet
    FOREIGN KEY (idRemito)
    REFERENCES tblslvRemito (idRemito);
