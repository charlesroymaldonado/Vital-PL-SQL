CREATE OR REPLACE TRIGGER trg_rep_tblslvControlRemito
    after insert or update on SLVAPP.tblslvControlRemito
    for each row                                
declare
...
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvControlRemito', v_Accion,:new.idcontrolremito, REPLICAS_GENERAL.get_estado_inicial, sysdate);
