CREATE OR REPLACE TRIGGER trg_rep_tblslvControlRemitodet
    after insert or update on SLVAPP.tblslvControlRemitodet
    for each row                                
declare
...
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvControlRemitodet', v_Accion,:new.idcontrolremitodet, REPLICAS_GENERAL.get_estado_inicial, sysdate);
