CREATE OR REPLACE TRIGGER trg_rep_tblslvpedfaltanterel
    after insert or update ON SLVAPP.TBLSLVPEDFALTANTEREL  for each row
declare
   v_modulo          varchar2(100) := 'trg_rep_tblslvpedfaltanterel';
   v_Accion          varchar2(3);
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvpedfaltanterel', v_Accion, :new.idpedfaltanterel, REPLICAS_GENERAL.get_estado_inicial, sysdate, :new.cdsucursal);
