CREATE OR REPLACE TRIGGER trg_rep_tblslvControlRemitodet
    after insert or update ON SLVAPP.TBLSLVCONTROLREMITODET     for each row
declare
   v_modulo          varchar2(100) := 'trg_rep_tblslvControlRemitodet';
   v_Accion          varchar2(3);
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvControlRemitodet', v_Accion,:new.idcontrolremitodet, REPLICAS_GENERAL.get_estado_inicial, sysdate, :new.cdsucursal);
