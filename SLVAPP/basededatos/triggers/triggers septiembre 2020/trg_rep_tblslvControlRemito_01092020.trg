CREATE OR REPLACE TRIGGER trg_rep_tblslvControlRemito
    after insert or update ON SLVAPP.TBLSLVCONTROLREMITO     for each row
declare
   v_modulo          varchar2(100) := 'trg_rep_tblslvControlRemito';
   v_Accion          varchar2(3);
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvControlRemito', v_Accion,:new.idcontrolremito, REPLICAS_GENERAL.get_estado_inicial, sysdate, :new.cdsucursal);
