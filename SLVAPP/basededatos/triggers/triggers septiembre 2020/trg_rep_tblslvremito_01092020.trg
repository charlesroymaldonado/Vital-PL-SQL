CREATE OR REPLACE TRIGGER trg_rep_tblslvremito
    after insert or update ON SLVAPP.TBLSLVREMITO     for each row
declare
...
begin
   ...
   values
   (seq_tblreplica.nextval, 'tblslvremito', v_Accion,:new.idremito, REPLICAS_GENERAL.get_estado_inicial, sysdate, :new.cdsucursal);
