SELECT aa.cdarticulo,da.vldescripcion,p.vigencia_desde,p.vigencia_hasta,p.id_promo
    ...
    WHERE     p.id_promo_tipo = t.id_promo_tipo
          ...
          AND t.id_promo_grupo = 1 -- que sea promo y no cupón
        ...
        --  and aa.cdarticulo = '159952'-- articulo a distribuir
         ...
         -- and trunc(to_date('21/07/2020','dd/mm/yyyy')) between p.vigencia_desde and p.vigencia_hasta --vigente el día que se tomó el pedido          
